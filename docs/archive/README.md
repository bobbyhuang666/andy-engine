...
- `audit-rounds/` — old audit reports, bug ledgers, and convergence summaries.
- `execution-plans/` — temporary plans written for execution agents.
- `implemented-rfcs/` — RFCs or design briefs whose work has been implemented.
- `phase-history/` — completed phase reports, roadmaps, and direction briefs.
- `root-cause/` — diagnostic reports from completed root-cause investigations.
...
guidance. They must not override source code, tests, `AGENTS.md`, or active docs.
